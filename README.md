...
| 강채연 | 김동명| 박창규 | 백하은| 홍준 |
| --- | --- | --- | --- | --- |
| ![IE001847808_STD](https://github.com/user-attachments/assets/c2f2176b-7c40-4769-b3a4-7dbef5565109) |![돌아이](https://github.com/user-attachments/assets/eac6eb13-7166-409a-9f04-defaeb629cfe)| <> |![강록이형](https://github.com/user-attachments/assets/3f3a4698-0df0-4028-8a9c-d8ced265a568)|![눈감성재](https://github.com/user-attachments/assets/19d76aae-223c-44b1-9fb9-57fd0991293f)|
...
1. 몇몇 Document(식당)에 대해서 정답률이 극단적으로 낮음.
</br>
2. 영업 시간에 혹은 휴무에 대한 질문을 어려워 함.</br>
- 연중무휴 혹은 무휴 등</br>
- > filter 추가로 개선</br>
...
4. 답하기 어려운 불완전한 질문 생성/</br>
```
Sample 15:
Question: 식당의 신규 오픈 날짜는 언제입니까?
Reference: 2023년 06월 15일
Response: 죄송하지만, [context]에 주어진 정보 중에서 2023년 06월 15일에 신규 오픈한 식당은 없습니다. 다른 정보를 제공해 주시면 확인해 드리겠습니다.
Context Used: 신규오픈날짜: 2023년 06월 15일
</br>
Sample 64:
Question: 주차는 가능한가요?
Reference: 가능(펜타스퀘어 주차장에 주차 시 1시간 무료 주차권 증정)
Response: 죄송하지만, [context]에 주어진 정보에서는 "펜타스퀘어 주차장"에 대한 정보가 없습니다. 대신, 다른 식당의 주차 가능 여부를 확인해드릴 수 있습니다. 특정 식당에 대한 주차 정보를 원하시면 식당 이름을 말씀해 주세요.
Context Used: 주차가능여부: 가능(펜타스퀘어 주차장에 주차 시 1시간 무료 주차권 증정)
```
</br>
</br>
## 5. 팀원 회고
